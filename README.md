...
### Links:
- A parte mandatória do desafio está [aqui](/parte%202/docs/automation-plan.md)
- Considerações sobre o projeto e lab da parte opcional [aqui](/parte%202/docs/lab.md)
