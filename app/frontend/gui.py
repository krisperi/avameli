...
def _create_configuration_frame(self, parent):
    ...
    ttk.Label(config_frame, text="VLAN ID").grid(row=1, column=0, sticky="w", padx=5, pady=5)
    ttk.Label(config_frame, text="VLAN Name").grid(row=1, column=1, sticky="w", padx=5, pady=5)

    ttk.Entry(config_frame, textvariable=self.vlan_1_id, width=15).grid(row=2, column=0, padx=5, pady=5, sticky="w")
    ttk.Entry(config_frame, textvariable=self.vlan_1_name, width=35).grid(row=2, column=1, padx=5, pady=5, sticky="w")

    ttk.Entry(config_frame, textvariable=self.vlan_2_id, width=15).grid(row=3, column=0, padx=5, pady=5, sticky="w")
    ttk.Entry(config_frame, textvariable=self.vlan_2_name, width=35).grid(row=3, column=1, padx=5, pady=5, sticky="w")

    ttk.Entry(config_frame, textvariable=self.vlan_3_id, width=15).grid(row=4, column=0, padx=5, pady=5, sticky="w")
    ttk.Entry(config_frame, textvariable=self.vlan_3_name, width=35).grid(row=4, column=1, padx=5, pady=5, sticky="w")
